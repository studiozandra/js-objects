...
completePerson = buildPerson(plainPerson, 'Masa', 33);
...
function printOneOrder(order){
    if(order < arrayOfObjects.length){
        ...
        console.log("purchase date: " + arrayOfObjects[order].date)
        console.log("purchase total: " + arrayOfObjects[order].total);
    }else{
 ...
 */
 ...
 function printObj(obj){
    obj.output = obj.a + obj.b;
    return obj.a + " + " + obj.b + " = " + obj.output;
 }
var sumObjResult = printObj(sumObjResult);
console.log(sumObjResult);
/*
 ...
 */
 ...
 function putInPlainBox(obj){
    for(i = 0; i< 10; i++){
        var getRandom = Math.floor(Math.random()* obj.length);
        var randomNum = obj[getRandom];
        return randomNum;
