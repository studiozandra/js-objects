/*
Objects in Javascript can be compared to objects in real life. An object has a collection of properties associated with it (known as key-value pairs) and are basically the same as ordinary variables.
*/ 
